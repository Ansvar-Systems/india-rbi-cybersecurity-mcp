/**
 * SQLite database access layer for the India RBI Cybersecurity MCP server.
 *
 * Schema:
 *   - frameworks  — RBI cybersecurity and risk management frameworks / master directions
 *   - controls    — Individual controls / directions within each framework
 *   - circulars   — RBI regulatory circulars and IT governance notices
 *
